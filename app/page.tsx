...
const previewBalances = [
  ...
  { name: "Priya", amount: "+INR 50", tone: "text-green-400" },
  { name: "Rohan", amount: "-INR 300", tone: "text-red-400" },
];
  ...
  return (
    <main className={pageClassName}>
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col px-4 py-6 sm:px-6 lg:px-8">
          <header className="flex items-center justify-between gap-4 py-2">
            <div>
              ...
              <p className={logoSubtextClassName}>Group expense tracking with accountability</p>
            </div>
            <nav className="flex items-center gap-2 sm:gap-3">
              <Link href="/login" className={navButtonClassName}>Login</Link>
              <Link href={isLoggedIn ? "/dashboard" : "/register"} className={primaryNavClassName}>
          ...
          <div className="grid gap-10 py-14 sm:py-18 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-14 lg:py-24">
            <div className="max-w-2xl">
              ...
              <p className="mt-5 max-w-xl text-base leading-7 sm:text-lg text-gray-300">
                  ...
                  <div className="mt-4 rounded-xl border border-gray-800 bg-gray-950 p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="mt-2 text-lg font-semibold text-white">Aarav pays Mugdha INR 170</p>
                      </div>
      ...
      <section id="how-it-works" className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          <p className="text-sm font-medium uppercase tracking-[0.2em] text-blue-300">How it works</p>
          <h2 className="mt-3 text-3xl font-semibold text-white sm:text-4xl">A simple flow your whole group can follow.</h2>
        </div>
      ...
      <section className="border-y border-gray-900 bg-gray-950/60">
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold text-white sm:text-4xl">More than just a calculator.</h2>
            <p className="mt-5 max-w-lg text-base leading-7 text-gray-300">The product already focuses on real group coordination: not just splitting numbers, but showing balances clearly, guiding settlements, and creating a more accountable shared-expense experience.</p>
          </div>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:px-8">
        <p className="text-sm font-medium uppercase tracking-[0.2em] text-blue-300">Ready to start</p>
